...
#PBS -l select=1:ncpus=8:ngpus=0:Qlist=Allnodes
#PBS -V
#PBS -o /home/viniciusp/doutorado/sub_mddf/jobout_mddf_bfno
#PBS -e /home/viniciusp/doutorado/sub_mddf/joberr_mddf_bfno
#!/bin/bash
