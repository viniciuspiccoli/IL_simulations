  ...
  function conc(MM::Float64,Nome::String,Nomean::String, conc::Float64)
      ...
      nil  = round(Int,(num_il(vs,c)));                # Número de moléculas de IL/ions para dada concentração
   
      nwat1 = num_wat(vs, v_il(nil,MM));               # Número de moléculas de água para preencher, levando em conta os dois LIs
      nwat = nwat1 
